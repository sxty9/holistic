...
// build-time registry glob. Aliases let those out-of-tree files resolve @holisdk/ui and a
// single React instance. Order matters: the tokens.css subpath must precede the bare alias.
export default defineConfig({
  plugins: [react()],
  resolve: {
    alias: [
      { find: '@holisdk/ui/tokens.css', replacement: r('../../holisdk/ui/src/tokens.css') },
      { find: '@holisdk/ui', replacement: r('../../holisdk/ui/src/index.ts') },
